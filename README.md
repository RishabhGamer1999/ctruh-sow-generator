...
Project Objective
Scope of Work
Timeline Table & Turnaround Notes
Iterations Included (2 Revision Rounds)
Out of Scope Exclusions
Acceptance Criteria (5-Day Approval Clause)
Commercials & Infrastructure Add-on Table
...
Go to console.groq.com and log in with Google (Free, no card required).
Go to API Keys → Create API Key and copy the key (gsk_...).
2. Deploy on Streamlit Community Cloud
Go to share.streamlit.io and connect your GitHub account.
Select this repository (ctruh-sow-generator), set the main file to streamlit_app.py.
